...
for i in range(T):
    ...
    for t in range(number_of_weeks):
        districts = campaign.apply_strategy(districts, t, effort_per_week, strategies_dict['Min losing'], strategies_dict['Min diff']) # change to strategies.user_input_strat for manual input
